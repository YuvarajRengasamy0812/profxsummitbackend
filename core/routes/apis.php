...
Route::get('/website/gallery', 'APIsController@gallery');
Route::get('/website/blog', 'APIsController@blog');
Route::get('/website/Sponsors', 'APIsController@Sponsors');
Route::get('/website/speakers', 'APIsController@speakers');
...
Route::post('/exhibitors', 'APIsController@exhibitorsSubmit');
...
Route::get('/floorplanList', 'APIsController@floorplanList');