                ...
                <tr>
                    <td valign="top" style="padding:0;Margin:0">
                        ...
                        <table cellpadding="0" cellspacing="0" class="es-header" align="center" role="none"
                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;margin-top: 50px;">
                            <tbody>
                                <tr>
                                    <td align="center" style="padding:0;Margin:0">
                                        <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0"
                                            cellspacing="0" role="none"
                                            style="border-collapse:collapse;background-color:transparent;width:600px">
                                            <tbody>
                                                <tr>
                                                    <td align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" style="font-size:0px">
                                                                                        <a href="https://profxleague.com">
                                                                                            <img src="https://profxleague.com/assets/frontend/images/mail_banner.png"
                                                                                                alt="Logo"
                                ...
                                <tr>
                                    <td align="center" style="padding:0;Margin:0">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                            cellspacing="0" role="none"
                                            style="border-collapse:collapse;background-color:#FFFFFF;width:600px">
                                            <tbody>
                                                <tr>
                                                    <td align="left"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="padding-bottom:10px">
                                                                                        <h1
                                                                                            style="margin:0;line-height:32px;font-family:Poppins,sans-serif;font-size:20px;font-weight:600;color:#333333">
                                                                                            Dear <?PHP echo $name ?>,
                                                                                        </h1>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" style="padding:10px 0">
                                                                                        <p style="margin:0;font-family:Poppins,sans-serif;font-size:14px;color:#333333;line-height:21px">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" style="padding:10px 0">
                                                                                        <p style="margin:0;font-family:Poppins,sans-serif;font-size:14px;color:#333333;line-height:21px">
                                                                                            Please stay tuned – we will share your trading credentials soon.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" style="padding:10px 0">
                                                                                        <p style="margin:0;font-family:Poppins,sans-serif;font-size:14px;color:#333333;line-height:21px">
                                                                                            Thank you for being part of the PROFXSPORTSCLUB.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" style="padding-top:15px">
                                                                                        <p style="margin:0;font-family:Poppins,sans-serif;font-size:14px;color:#333333;line-height:21px">
                                                                                            Best regards,<br>The PROFXSPORTSCLUB Team
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        <table class="es-footer-body" align="center" cellpadding="0" cellspacing="0"
                                            style="width:600px;background-color:transparent" role="none">
                                            <tbody>
                                                <tr>
                                                    <td align="left">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="none">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" bgcolor="#051c35" style="padding:15px 0">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-right:40px">
                                                                                        <a href="https://x.com/profxleague"
                                                                                            style="text-decoration:none;color:white;font-size:22px;">𝕏</a>
                                                                                    </td>
                                                                                    <td style="padding-right:40px">
