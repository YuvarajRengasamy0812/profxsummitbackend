    ...
    <div class="left navside dk" layout="column">
        ...
        <div class="navbar navbar-md no-radius">
            ...
            <a class="navbar-brand" href="{{ route('adminHome') }}">
                <img src="{{ asset('assets/dashboard/images/profx-black.png') }}" alt="Control">
...
<i class="material-icons">&#xe7ef;</i>
                  ...
                  <span class="nav-icon">
                    ...
                    <li class="{{ request()->routeIs('floorplanList') || request()->routeIs('floorplanList') ? 'active' : '' }}">
					 ...
					 <li class="{{ request()->routeIs('profxusers') || request()->routeIs('profxusers') ? 'active' : '' }}">
						<a href="{{ route('profxusers') }}" ><span class="nav-icon"><i class="material-icons">&#xe7fb;</i></span>
