...
<div class="profx-view-wrapper">
    <h4>profxusers Details</h4>
    
    <table class="profx-view-table">
        <tr><th>ID</th><td>{{ $profxusers->id }}</td></tr>
        <tr><th>Name</th><td>{{ $profxusers->full_name }}</td></tr>
        <tr><th>Email</th><td>{{ $profxusers->email }}</td></tr>
        <tr><th>Phone</th><td>{{ $profxusers->phone }}</td></tr>
        <tr><th>Company</th><td>{{ $profxusers->company_name }}</td></tr>

     
        <tr><th>Created At</th><td>{{ $profxusers->created_at }}</td></tr>
        <tr><th>Updated At</th><td>{{ $profxusers->updated_at }}</td></tr>
    </table>

    <a href="{{ route('profxusers') }}" class="profx-view-back-btn">Back to List</a>
</div>
